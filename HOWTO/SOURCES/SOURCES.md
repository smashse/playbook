...
- [Terraform Up and Running (EARLY RELEASE)](https://www.academia.edu/39574550/Terraform_Up_and_Running)
...
[Trilhas interessantes quanto a EKS, Grafana, Kubernetes e etc.](https://www.eksworkshop.com/)

## Eric Evans

- [Domain-Driven Design: Tackling Complexity in the Heart of Software](https://www.dddcommunity.org/book/evans_2003/)
- [Tradução de Ricardo Pereira Dias](https://www.ricardopedias.com.br/assets/docs/ddd-referencia.pdf)

## FIAP + Movimento Brasil Digital

- [20 Nano Courses gratuitos](https://on.fiap.com.br/local/movimentobrasildigital/)

## Full Cycle Development

- [Netflix](https://netflixtechblog.com/full-cycle-developers-at-netflix-a08c31f83249)

- [Full Cycle](https://fullcycle.com.br/tudo-que-voce-precisa-saber-sobre-full-cycle-development)
...
- [Enterprise Roadmap to SRE - Google - Site Reliability Engineering](https://sre.google/resources/practices-and-processes/enterprise-roadmap-to-sre)

## IBM

- [DevOps for Dummies](http://athena.ecs.csus.edu/~buckley/CSc131_files/DevOps%20for%20Dummies.pdf)

- [The DevOps Toolbox](https://www.linuxjournal.com/sites/default/files/2018-11/GeekGuide-DevOpsToolbox-v2-2.pdf)

## Info Trek

- [Kubernetes Up & Running (SECOND EDITION)](https://info-trek.microsoftcrmportals.com/kubernetes-up-and-running-ebook-infotrek/)
...
- [Effective DevOps](https://www.microsoft.com/azure/partners/news/article/effective-devops-building-a-devops-culture-at-scale)
...
- [Perguntas frequentes: Qual é a relação entre SRE e DevOps?](https://docs.microsoft.com/pt-br/azure/site-reliability-engineering/articles/devops)
...
- [NGINX Library - Resources, Reports, & Ebooks](https://www.nginx.com/resources/library/)
...
- [Kubernetes Management For Dummies](https://info.rancher.com/kubernetes-management-for-dummies-rancher-and-suse-0-0)
...
- [Kubernetes: Getting Started](https://www.udemy.com/course/kubernetes-getting-started/?ranMID=39197&ranEAID=JVFxdTr9V80&ranSiteID=JVFxdTr9V80-HrfbdfiuxstLACD3WnLAAQ&LSNPUBID=JVFxdTr9V80&utm_source=aff-campaign&utm_medium=udemyads)

## VMware

- [Kubernetes Up & Running (THIRD EDITION)](https://tanzu.vmware.com/content/ebooks/kubernetes-up-running-dive-into-the-future-of-infrastructure)

- [Production Kubernetes](https://tanzu.vmware.com/content/ebooks/production-kubernetes)

- [Books authored by VMware Tanzu advocates on cloud-native technology](https://tanzu.vmware.com/content/ebooks)
