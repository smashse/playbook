...
**Note:** The type of instance and the number of nodes are just to make it more practical to observe the example regarding Auto Scaling, if you want to use the instructions contained here in a close-to-real environment, the values in the "**--nodes-min**" fields , "**--nodes-max**" and "**--instance-types**" should be changed according to your needs.
